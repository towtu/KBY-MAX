...
KBY MAX is a cinematic streaming-style frontend for browsing movies, TV shows, and K-dramas.
...
- Dedicated Movies and TV Shows hubs with quick category filters
- Trending, top-rated, genre, and K-drama discovery sections
...
- Local browser-based watch progress and My List behavior
- Multiple embedded player server options for better playback fallback

## Content Sources

KBY MAX uses TMDB for movie and TV metadata, plus embedded third-party players for playback.
